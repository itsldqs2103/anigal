...
export default function Terms() {
  ...
  return (
    <div className="p-4">
      ...
      <section className="bg-base-100 rounded-default space-y-4 p-4 shadow-lg">
        <p>
        ...
        <div>
          ...
          <p>
            AniGal is provided <span className="font-bold">as is</span> without
            warranties of any kind. We do not guarantee accuracy, availability,
        ...
        <div>
          ...
          <p>
            ...
            use of the site indicates acceptance of any changes.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            <Link
              href="/privacy"
              className="hover:text-accent font-bold transition-[color]"
            >
              Privacy Policy
            </Link>
